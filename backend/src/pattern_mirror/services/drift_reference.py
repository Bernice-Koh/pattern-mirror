...
peer feedback (added with #120). One resolver so the streaming endpoints attach drift the same
way for every surface, swapping only the corpus — the "swapped reference, not a new engine"
guarantee (design spec §3, §8) made a single call site.
"""
